      ...
      $.ajax({url:tbmapi,type:"GET",dataType:"json", success:function(jdata)
              {
                ...
                $("div.cwalt:eq(3)").append('<img src="https://www.elitepvpers.com/images/tbm/trades.gif"> Your version: <i>' + GM_info['script']['version'] + '</i> | Current version: <i>' + 'n/a' + '</i> <a href="https://github.com/Der-Eddy/epvp-tbm-dashboard/raw/master/tbm_dashboard.user.js">(Instant Update)</a><br>');
